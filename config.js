...
const botlindo = 'HIHIHI OBGDD'
const linkbotlindo = 'https://photos1.iorbix.com/00/00/00/00/02/72/43/64/C--6tZwaASQH-b.jpg'
const botfeio = 'Tu parece um sirgueijo, um caranguejo amassado 😡'
const cadebot = 'Me chamou onii-chan 👉👈?'
const botfdp = 'Te foder rapaz, te deitar na porrada seu merda'
const botgostoso = 'Hehehe as nova pira 👉👈'
const botfofo = 'Sempre fui ksks 😳👉👈'
...
let mess = {
    wait: '⌛ Espera afobado do fazendo... ⌛',
    success: '✔️ Foi, Ufa! kkk ✔️',
    error: {
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=5511047507076:+55 11 94750-7076\n' 
+ 'END:VCARD'
